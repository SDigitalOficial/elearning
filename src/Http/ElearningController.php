...
public function delete($id) {
 ...
 if(!$this->tenantName){
  ...
  $version = Version::all();
  $curso = Cursos::leftjoin('elearning_lecciones','elearning_cursos.id','=','elearning_lecciones.curso_id')
     ->select('nombre')
     ->selectRaw('count(curso_id) as sum')
     ->groupBy('nombre')
     ->where('elearning_cursos.id', '=', $id)
     ->get();
  }else{
  ...
  $version = \DigitalsiteSaaS\Elearning\Tenant\Version::all();
    $curso = \DigitalsiteSaaS\Elearning\Tenant\Cursos::leftjoin('elearning_lecciones','elearning_cursos.id','=','elearning_lecciones.curso_id')
     ->select('nombre')
     ->selectRaw('count(curso_id) as sum')
     ->groupBy('nombre')
     ->where('elearning_cursos.id', '=', $id)
 ...
 return view('elearning::tema-general')->with('contenido', $contenido)->with('lecciones', $lecciones)->with('version', $version)->with('curso', $curso);
}
